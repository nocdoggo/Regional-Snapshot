...
def create_layout(app, region, region_code, view_style):
    ...
    df_HS = pd.read_csv(DATA_PATH.joinpath("SD_U-46_Prog.csv"),
                                    ...
                                    html.Div(
                                        [
                                            ...
                                            html.P(
                                                ...
                                                Covering 90 square miles, the district serves portions of eleven communities in the northwest suburbs of Chicago in Cook, \
                                                DuPage and Kane Counties. School District U-46 serves over 40,000 children in grades preK-12. \
                                                The district ranks as the second largest in Illinois with forty elementary schools, eight middle schools and five high schools.",
                                                style={"color": "#000000"},
