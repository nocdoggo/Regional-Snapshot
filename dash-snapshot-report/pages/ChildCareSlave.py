                        ...
                        [
                            html.Div(
                                [
                                    ...
                                    html.H6(
                                        [html.Strong("Early Child Care Service Location at " + region)], className="subtitle padded"
                                    ),

                                    html.Img(src='data:image/png;base64,{}'.format(site_base64), style={'max-width': '100%',
                                                            'max-height': '100%',
                                                            'margin': 'auto',
                                                            'display': 'block'},),
